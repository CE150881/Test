<%-- 
    Document   : new
    Created on : Jun 20, 2021, 3:16:07 PM
    Author     : ngonh
--%>
...
<html style="font-size: 16px;" lang="vi-VN">
    ...
    <body class="u-body"><header class="u-align-center-xs u-clearfix u-custom-color-3 u-header u-sticky u-header" id="sec-e122"><div class="u-clearfix u-sheet u-sheet-1">
                ...
                <div class="u-custom-menu u-nav-container" style="margin-top: -50px; margin-left: -90px">
                    <ul class="u-custom-font u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-black" href="home" style="padding: 5px 75px;">TRANG CHỦ</a>
                        </li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-black" href="menu" style="padding: 5px 75px;">THỰC ĐƠN</a>
                        </li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-black" href="about.jsp" style="padding: 5px 75px;">GIỚI THIỆU</a>
                        </li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-black" href="contact.jsp" style="padding: 5px 75px;">LIÊN HỆ</a>
                        </li></ul>
                </div>
        ...
        <section class="u-clearfix u-palette-3-light-3 u-section-1" id="sec-b24d">
            <div class="u-clearfix u-sheet u-sheet-1">
                <p class="u-custom-font u-text u-text-custom-color-3 u-text-1" data-animation-name="zoomIn" data-animation-duration="1000" data-animation-delay="0" data-animation-direction="">ĐĂNG Ký</p>
                <div class="u-image u-image-circle u-preserve-proportions u-image-1" alt="" data-image-width="1500" data-image-height="1500" data-href="Home.jsp" data-page-id="150508545"></div>
                <div class="u-form u-form-1">
                    <form action="signup" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px;" source="custom" name="form">
                        <div class="u-form-group u-form-group-1">
                            <label for="text-9294" class="u-custom-font u-label u-label-1">Tên đăng nhập</label>
                            <input type="text" placeholder="Nhập tên đăng nhập" id="text-9294" name="user" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" pattern="[A-Za-z0-9]{5,20}" title="Letters and numbers only, please." required="required">
                        </div>
                        <div class="u-form-group u-form-group-2">
                            <label for="text-18e9" class="u-custom-font u-label u-label-2">Mật khẩu </label>
                            <input type="password" placeholder="Xác nhận mật khẩu" id="text-18e9" name="pass" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" maxlength="16" minlength="8" onmouseover="mouseoverPass();" onmouseout="mouseoutPass();" required="required">
                        </div>
                        <div class="u-form-group u-form-group-3">
                            <label for="text-d755" class="u-custom-font u-label u-label-3">Xác nhận mật khẩu </label>
                            <input type="password" id="text-d755" name="repass" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" maxlength="16" minlength="8" placeholder="Xác nhận mật khẩu mới" onmouseover="mouseoverPass2();" onmouseout="mouseoutPass2();" required="required">
                        </div>

                        <div class="u-form-group u-form-phone">
                            <label for="email-158d" class="u-custom-font u-label u-label-5">Số điện thoại</label>
                            <input type="tel" pattern="[0][0-9]{9}" id="phone11" name="phone" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white"  required="required" maxlength="10" placeholder="Nhập số điện thoại" oninput="formValidate()">
                        </div>
                        <div class="u-form-email u-form-group u-form-group-4">
                            <label for="address-f3ab" class="u-custom-font u-label u-label-4">Email</label>
                            <input type="email" placeholder="Email"id="address-f3ab" name="mail" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" required="required">
                        </div>
                        <div class="u-form-group u-form-select u-form-group-6">
                            <label for="select-f270" class="u-custom-font u-label u-label-6">Giới tính</label>
                            <div class="u-form-select-wrapper">
                                <select id="select-f270" name="gender" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" required="required">
                        ...
                        <div class="u-align-right u-form-group u-form-submit">
                            <input  class="u-border-3 u-border-custom-color-3 u-border-hover-custom-color-3 u-btn u-btn-round u-btn-submit u-button-style u-custom-color-3 u-custom-font u-hover-white u-radius-16 u-text-hover-custom-color-3 u-btn-1" type="submit" value="Đăng ký" >
                        </div>
                    </form>
                </div>
            </div>
        ...
        <footer class="u-align-center u-clearfix u-custom-color-3 u-footer u-footer" id="sec-8076"><div class="u-clearfix u-sheet u-sheet-1">
                ...
                <a href="Chính-sách-hoạt-động.html" data-page-id="72988464" class="u-active-none u-border-1 u-border-active-palette-2-dark-1 u-border-hover-black u-border-white u-btn u-button-style u-custom-font u-hover-none u-none u-text-body-alt-color u-text-hover-black u-btn-2">Chính sách hoạt động<br>
                </a>
                <a href="Hệ-thống-cửa-hàng.html" data-page-id="219125604" class="u-active-none u-border-1 u-border-active-palette-2-dark-1 u-border-hover-black u-border-white u-btn u-button-style u-custom-font u-hover-none u-none u-text-body-alt-color u-text-hover-black u-btn-3">Hệ thống cửa hàng</a>
                <a href="LIÊN-HỆ.html" data-page-id="80271350" class="u-active-none u-border-1 u-border-hover-black u-border-white u-btn u-button-style u-custom-font u-hover-none u-none u-text-body-alt-color u-text-hover-black u-btn-4">Liên hệ<br>
                </a>
            </div></footer>
        ...
        <script>
            function mouseoverPass(obj) {
                var obj = document.getElementById('text-18e9');
                obj.type = "text";
            }
            ...
            function mouseoverPass2(obj) {
                var obj = document.getElementById('text-d755');
                obj.type = "text";
            }
