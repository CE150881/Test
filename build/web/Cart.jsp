<%-- 
    Document   : Cart
    Created on : Jun 22, 2021, 11:09:18 PM
    Author     : msi-pc
--%>
...
<html style="font-size: 16px;" lang="vi-VN">
    <head>
        ...
        <link rel="stylesheet" href="Giỏ-hàng.css" media="screen">
    ...
    <body class="u-body">        <header class="u-align-center-xs u-clearfix u-custom-color-3 u-header u-sticky u-header" id="sec-e122"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <section class="u-clearfix u-palette-3-light-3 u-section-1" id="sec-82e2">
            <div class="u-clearfix u-sheet u-sheet-1">
                ...
                <a href="menu" data-page-id="207006172" class="u-active-none u-btn u-button-style u-custom-font u-hover-none u-none u-text-black u-btn-1">Thực đơn</a>
            </div>
        </section>
                                    ...
                                    <div class="container skin">
                                        <div class="row skin">
                                            <div class="col-lg-12 p-5  rounded shadow-sm mb-5 skin">
                                                ...
                                                <!-- Shopping cart table -->
                                                <div class="table-responsive skin">
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
