<%-- 
    Document   : Đăng-nhập
    Created on : Jun 1, 2021, 4:08:49 PM
    Author     : msi-pc
--%>
...
<html style="font-size: 16px;" lang="vi-VN">
    ...
    <body class="u-body"><header class="u-align-center-xs u-clearfix u-custom-color-3 u-header u-sticky u-header" id="sec-e122"><div class="u-clearfix u-sheet u-sheet-1">
                ...
                <nav class="u-custom-menu u-nav-container" style="margin-top: -50px; margin-left: -90px">
                    <ul class="u-custom-font u-nav u-unstyled u-nav-1" >
                        <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-black" href="home" style="padding: 5px 75px;">TRANG CHỦ</a>
                        ...
                        <tbody class="u-align-center u-table-body">
                            <tr style="height: 55px;">
                                <td class="u-table-cell">
                                    <a href="login.jsp" data-page-id="123672971" class="u-text-active-black u-active-none u-border-none u-btn u-button-link u-button-style u-custom-font u-hover-none u-none u-text-body-alt-color u-text-hover-black u-btn-1">Đăng nhập</a>
                                </td>
                                <td class="u-table-cell">
        ...
        <section class="u-clearfix u-palette-3-light-3 u-section-1" id="sec-1407">
            <div class="u-clearfix u-sheet u-sheet-1">
                ...
                <div class="u-form u-form-1">
                    ...
                    <form action="login" method="POST" class="u-clearfix u-form-spacing-22 u-form-vertical u-inner-form" style="padding: 29px;" source="custom" name="form">
                        <div class="u-form-group u-form-group-1">
                            ...
                            <input type="text" placeholder="Tên đăng nhập" id="text-3332" name="user" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white">
                        </div>
                        <div class="u-form-group u-form-group-2">
                            <label for="text-1265" class="u-form-control-hidden u-label"></label>
                            <input type="password" placeholder="Mật khẩu" id="text-1265" name="pass" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-15 u-white" onmouseover="mouseoverPass()" onmouseout="mouseoutPass()">
                        </div>
                        <div class="u-align-center u-form-group u-form-submit">

                            <input class="u-border-3 u-border-custom-color-3 u-border-hover-custom-color-3 u-btn u-btn-round u-btn-submit u-button-style u-custom-color-3 u-custom-font u-hover-white u-radius-11 u-text-hover-custom-color-3 u-btn-1" type="submit" value="Đăng nhập" >
                        </div>
                ...
                <p class="u-text u-text-1">
                    <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-custom-font u-hover-none u-none u-text-custom-color-3 u-btn-2" href="signup.jsp" data-page-id="383923227">vào đây</a>
                </p>
                <p class="u-custom-font u-text u-text-2">Bạn chưa có tài khoản? Nhấn</p>
                <p class="u-custom-font u-text u-text-3">để đăng kí.</p>
            </div>
        </section>
        ...
        <footer class="u-align-center u-clearfix u-custom-color-3 u-footer u-footer" id="sec-8076"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
                ...
                <a href="Chính-sách-hoạt-động.html" data-page-id="72988464" class="u-active-none u-border-1 u-border-active-palette-2-dark-1 u-border-hover-black u-border-white u-btn u-button-style u-custom-font u-hover-none u-none u-text-body-alt-color u-text-hover-black u-btn-2" target="_blank">Chính sách hoạt động<br>
                </a>
        ...
        <script>
            function mouseoverPass(obj) {
                var obj = document.getElementById('text-1265');
                obj.type = "text";
            }
